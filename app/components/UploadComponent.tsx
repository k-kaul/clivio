...
const UploadExample = () => {
    ...
    return (
            <div className="flex flex-col items-center gap-4 border-2 border-black"> 
                ...
                <input type="file" accept="image/*,video/*" ref={fileInputRef} className="border border-black" />
                {/* Button to trigger the upload process */}
                <button type="button" onClick={handleUpload} className="bg-blue-600 text-white px-8">
                    Upload file
                </button>
                <br />
